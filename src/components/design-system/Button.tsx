  ...
  (
    ...
    return (
      <StyledButton
        ...
        {...props}
      >
        {leftIcon && !iconOnly && <IconWrapper>{leftIcon}</IconWrapper>}

        {iconOnly ? <IconWrapper>{leftIcon || rightIcon || children}</IconWrapper> : children}

        {rightIcon && !iconOnly && <IconWrapper>{rightIcon}</IconWrapper>}
      </StyledButton>
    );
  }
);
