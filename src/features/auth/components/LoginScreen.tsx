  ...
  return (
    <CoordinatorLayout>
      ...
      <ContentLayout>
        <NewLoginMainContainer>
          ...
          <BottomLinkContainer role="navigation" aria-label="보조 메뉴">
            <BottomLink 
              ...
              aria-label="새 계정 회원가입"
              type="button"
            >
              회원가입
            </BottomLink>
            <LinkDivider aria-hidden="true">|</LinkDivider>
            <BottomLink 
              onClick={handleAuthCenter}
              aria-label="인증센터 및 비밀번호 재설정"
              type="button"
            >
              인증센터
            </BottomLink>
        ...
        <LoginFooter 
          onOtherLoginClick={handleOtherLoginClick}
          onSimplePay={handleSimplePay}
        />
      </ContentLayout>
      <LoginBottomSheet
