...
export const useScreenReader = (): UseScreenReaderReturn => {
  ...
  const announce = useCallback(
    (message: string, options?: Partial<AnnouncementOptions>) => {
      screenReader.announce(message, options);
    },
    [screenReader]
  );

  const announceBalance = useCallback(
  ...
  const announceTransaction = useCallback(
...
export const useTransactionAnnouncement = () => {
  ...
  const announceTransferStart = useCallback(
    (amount: number, fromAccount: string, toAccount: string) => {
  ...
  const announceTransferComplete = useCallback(
    (amount: number, fromAccount: string, toAccount: string) => {
  ...
  const announceTransferError = useCallback(
    (error: string) => {
  ...
  const announceBalanceInquiry = useCallback(
    (balance: number, accountName: string) => {
...
export const useNavigationAnnouncement = () => {
  ...
  const announcePageChange = useCallback(
    (pageName: string, breadcrumb?: string[]) => {
  ...
  const announceTabChange = useCallback(
    (tabName: string, tabIndex: number, totalTabs: number) => {
...
export const useTableAnnouncement = () => {
  ...
  const announceTableInfo = useCallback(
    (rows: number, columns: number, caption?: string) => {
