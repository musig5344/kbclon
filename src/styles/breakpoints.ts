...
// 미디어 쿼리 생성 함수
export const createMediaQuery = (minWidth?: number, maxWidth?: number, minHeight?: number, maxHeight?: number, orientation?: 'portrait' | 'landscape') => {
  const conditions = [];
...
export const MEDIA_QUERIES = {
  ...
  // 모든 폰 크기 (세로 모드)
  phonePortrait: createMediaQuery(BREAKPOINTS.phoneSmall, BREAKPOINTS.phoneLarge, undefined, undefined, 'portrait'),
  
  // 모든 폰 크기 (가로 모드)
  phoneLandscape: createMediaQuery(BREAKPOINTS.phoneSmall, BREAKPOINTS.phoneLarge, undefined, undefined, 'landscape'),
  ...
  // 폴더블 특정 상황
  foldableClosedPortrait: createMediaQuery(BREAKPOINTS.foldableClosed, BREAKPOINTS.foldableClosed + 50, PORTRAIT_HEIGHTS.foldableClosedPortrait, undefined, 'portrait'),
  foldableOpenLandscape: createMediaQuery(BREAKPOINTS.foldableOpen, BREAKPOINTS.foldableOpen + 100, undefined, LANDSCAPE_HEIGHTS.foldableOpenLandscape, 'landscape'),
  ...
  // 태블릿 세로/가로 모드
  tablet7Portrait: createMediaQuery(BREAKPOINTS.tablet7, BREAKPOINTS.tablet10 - 1, PORTRAIT_HEIGHTS.tablet7Portrait, undefined, 'portrait'),
  tablet10Portrait: createMediaQuery(BREAKPOINTS.tablet10, BREAKPOINTS.tablet12 - 1, PORTRAIT_HEIGHTS.tablet10Portrait, undefined, 'portrait'),
  tablet12Portrait: createMediaQuery(BREAKPOINTS.tablet12, BREAKPOINTS.desktop - 1, PORTRAIT_HEIGHTS.tablet12Portrait, undefined, 'portrait'),
  
  tablet7Landscape: createMediaQuery(BREAKPOINTS.tablet7, BREAKPOINTS.tablet10 - 1, undefined, LANDSCAPE_HEIGHTS.tablet7Landscape, 'landscape'),
  tablet10Landscape: createMediaQuery(BREAKPOINTS.tablet10, BREAKPOINTS.tablet12 - 1, undefined, LANDSCAPE_HEIGHTS.tablet10Landscape, 'landscape'),
  tablet12Landscape: createMediaQuery(BREAKPOINTS.tablet12, BREAKPOINTS.desktop - 1, undefined, LANDSCAPE_HEIGHTS.tablet12Landscape, 'landscape'),
