...
const PLACEHOLDER_IMAGE =
  'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNjAiIGhlaWdodD0iNjAiIHZpZXdCb3g9IjAgMCA2MCA2MCIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPGNpcmNsZSBjeD0iMzAiIGN5PSIzMCIgcj0iMzAiIGZpbGw9IiNGRkI4MDAiLz4KPHN0YXIgZmlsbD0iI0ZGRiIvPgo8L3N2Zz4K';
...
export const useLoadingAnimation = (options: UseLoadingAnimationOptions = {}) => {
  const { type = 'type1', frameRate = 60, autoStart = true } = options;
