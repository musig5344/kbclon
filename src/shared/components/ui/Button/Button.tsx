...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const defaultTouchFeedback: TouchFeedbackOptions = {
      type:
        variant === 'primary' || variant === 'native-primary'
          ? 'ripple'
          : variant === 'secondary' || variant === 'native-secondary'
            ? 'scale'
            : 'press',
      intensity:
        size === 'small' ? 'light' : size === 'large' || size === 'full' ? 'strong' : 'medium',
      haptic: true,
      androidOptimized: true,
      color:
        variant?.includes('native') || variant === 'ghost'
...
export const TextButton = React.forwardRef<HTMLButtonElement, Omit<ButtonProps, 'variant'>>(
...
>((props, ref) => <Button ref={ref} variant='native-primary' {...props} />);
NativePrimaryButton.displayName = 'NativePrimaryButton';

export const NativeSecondaryButton = React.forwardRef<
  HTMLButtonElement,
  Omit<ButtonProps, 'variant'>
>((props, ref) => <Button ref={ref} variant='native-secondary' {...props} />);
NativeSecondaryButton.displayName = 'NativeSecondaryButton';

export const NativeGhostButton = React.forwardRef<HTMLButtonElement, Omit<ButtonProps, 'variant'>>(
  (props, ref) => <Button ref={ref} variant='native-ghost' {...props} />
);
