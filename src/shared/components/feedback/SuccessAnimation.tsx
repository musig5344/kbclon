...
export const SuccessAnimation: React.FC<SuccessAnimationProps> = ({
  ...
  return (
    <AnimationContainer $show={show}>
      {type === 'confetti' && <ConfettiContainer>{renderConfetti()}</ConfettiContainer>}
